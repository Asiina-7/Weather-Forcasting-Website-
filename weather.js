...
function showWeaterReport(weather) {
    ...
    if(city_code==='400'){ 
        swal("Empty Input", "Please Enter a Location", "Error");
        reset();
    }else if(city_code==='404'){
        swal("Bad Input", "Invalid Input of Location doesn't Exists", "Warning");
        reset();
    }
    else{
...
function changeBg(status) {
    if (status === 'Clouds') {
        ...
        document.body.style.backgroundImage = 'url(../images/thunder.png)';
    } 
